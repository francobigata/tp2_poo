...
public class GeneradorInformes {
    ...
    public void generarInformeProporcionVentas() {
        Map<String, Long> ventasPorTipoCombustible = estacionServicio.getVentasCombustible().stream()
                .collect(Collectors.groupingBy(Venta::getTipoProducto, Collectors.counting()));
    ...
    public void generarInformeEmpleadosPorMonto() {
        ...
        for (Venta venta : estacionServicio.getVentasCombustible()) {
